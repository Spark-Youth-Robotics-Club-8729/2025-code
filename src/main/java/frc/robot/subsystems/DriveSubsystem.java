...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    try{
      ...
      e.printStackTrace();
      throw new RuntimeException("Failed to load RobotConfig from PathPlanner GUI", e);
    }

    // Configure AutoBuilder last (https://pathplanner.dev/pplib-getting-started.html#install-pathplannerlib)
